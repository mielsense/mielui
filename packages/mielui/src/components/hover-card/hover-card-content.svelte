            ...
            {#if open}
                <div {...wrapperProps} class="z-[130]">
                    <div
                        ...
                        in:panelIn
                        out:panelOut
                        class={cn(className, overlaySurface(surface), 'mielui-modal-frame w-64 max-w-[calc(100vw-1rem)] origin-[var(--bits-link-preview-content-transform-origin)] overflow-hidden text-[var(--font-size-body)] text-foreground shadow-[var(--elevation-float)] [--mielui-modal-inset:calc(var(--spacing)*0.5)]')}
                    >
