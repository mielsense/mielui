 ...
 * - `mielui`: the built-in GitHub palette (light in light mode, dark in dark mode).
 * - `custom`: no token colors; load any `highlight.js/styles/*` theme instead.
 */
export type CodeBlockTheme = 'mielui' | 'custom';
...
export type CodeBlockProps = {
    ...
    /**
     * Syntax paint:
     * - `mielui` (default): the built-in GitHub palette.
     * - `custom`: no token colors; load any `highlight.js/styles/*` theme instead.
     */
    theme?: CodeBlockTheme;
} & DefaultProps;
