...
<div data-docs-page class="flex flex-col gap-10">
    ...
    <section id="installation" class="flex flex-col gap-4">
        ...
        <InstallCommand command="pnpm dlx @mielui/svelte add separator" />
    </section>
    <section id="usage" class="flex flex-col gap-4">
        <Typography.H2>Usage</Typography.H2>
        <Typography.Text>
            Separator renders a semantic separator by default. Set decorative when spacing and
            styling already convey the grouping and no landmark is needed. orientation="vertical"
            needs a surrounding row with a defined height; horizontal dividers fill the available
            width. Native attributes, class, and bind:element are forwarded.
        </Typography.Text>
    </section>
</div>
