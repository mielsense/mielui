...
<div data-docs-page class="flex flex-col gap-10">
    <header class="flex items-start justify-between gap-4">
        <div>
            ...
            ><Typography.Text variant="lead" class="mt-2"
                >Visually connect related controls.</Typography.Text
            >
        </div>
        <DocsPager />
    </header>
    ...
    <section id="usage" class="flex flex-col gap-4">
        <Typography.H2>Usage and accessibility</Typography.H2>
        <Typography.Text
            ...
            Tab moves between controls normally.</Typography.Text
        >
        <Typography.Text
            >Use Group for actions and ToggleGroup for controls that select a state. Group does not
            add arrow-key navigation or selection.</Typography.Text
        >
    </section>
    ...
    <section id="composition" class="flex flex-col gap-4">
        ...
        <Typography.Text
            ...
            class on any part to restyle it.</Typography.Text
        >
        <Typography.Text
            ...
            Native attributes and event handlers pass through to each part.</Typography.Text
        >
    </section>
</div>
