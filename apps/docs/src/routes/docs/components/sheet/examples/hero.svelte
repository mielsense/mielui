<script lang="ts">
    ...
    function createIssue() {
        ...
        created = `Created ${issueTitle.trim()} in this preview.`;
        reset();
        open = false;
    }
</script>
...
<div class="flex flex-col items-center gap-3">
        ...
        <Sheet.Root bind:open>
            ...
            <Sheet.Content side="right">
                ...
                <Sheet.Footer>
                    ...
                    <Button onclick={createIssue} disabled={!canCreate}>
                        Create issue
                        <Kbd shortcut="enter" />
                    </Button>
                </Sheet.Footer>
    ...
    <p role="status" class="text-sm text-foreground-muted">{created}</p>
</div>
